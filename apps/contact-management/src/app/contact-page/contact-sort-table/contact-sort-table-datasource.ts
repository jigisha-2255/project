...
/**
 * Data source for the ContactSortTable view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ContactSortTableDataSource extends DataSource<ContactModel> {
  // data: ContactModel[] = EXAMPLE_DATA;
  ...
  constructor(private elementData: ElementDataService) {
    ...
    this.data = elementData.getSessionDataMethod();
  }
  ...
  private getSortedData(data: ContactModel[]): ContactModel[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'empPosition': return compare(a.empPosition, b.empPosition, isAsc);
        default: return 0;
      }
    });
  }
